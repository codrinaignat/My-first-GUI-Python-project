...
btn4 = tk.Button(buttonFrame, text="7", font=('Times New Roman', 18))
btn4.grid(row=2, column=0, sticky=tk.W+tk.E)

btn5 = tk.Button(buttonFrame, text="8", font=('Times New Roman', 18))
btn5.grid(row=2, column=1, sticky=tk.W+tk.E)

btn6 = tk.Button(buttonFrame, text="9", font=('Times New Roman', 18))
btn6.grid(row=2, column=2, sticky=tk.W+tk.E)

btn4 = tk.Button(buttonFrame, text="0", font=('Times New Roman', 18))
btn4.grid(row=3, column=0, sticky=tk.W+tk.E)

btn5 = tk.Button(buttonFrame, text="+", font=('Times New Roman', 18))
btn5.grid(row=3, column=1, sticky=tk.W+tk.E)

btn6 = tk.Button(buttonFrame, text="-", font=('Times New Roman', 18))
